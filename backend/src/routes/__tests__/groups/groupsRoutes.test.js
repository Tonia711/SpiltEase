...
// beforeEach(async () => {
//   await User.deleteMany({ email: "group@test.com" });
//   await Group.deleteMany({ groupName: /Test Group|Validate Group|Group Update|Group To Delete/ });
...
//     joinCode = res.body.group.joinCode;
//   });
...
//   // --- 8. updateGroupIcon (占位，可实现上传模拟测试) ---
//   it.skip("should upload group icon and update iconId", async () => {
//     // 你可以 mock multer 或准备一个测试图像文件
//   });
// });
